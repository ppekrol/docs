...
function getOnlyIncludeVersions() {
    var versionsEnv = process.env.DOCUSAURUS_VERSIONS;
    if (!versionsEnv) {
        return undefined;
    }
    return versionsEnv.split(",").map(function (v) { return v.trim(); });
}
var config = {
    ...
    themeConfig: {
        ...
        footer: {
            ...
            copyright: "Copyright \u00A9 ".concat(new Date().getFullYear(), " RavenDB"),
        },
        prism: {
            theme: prism_react_renderer_1.themes.nightOwlLight,
