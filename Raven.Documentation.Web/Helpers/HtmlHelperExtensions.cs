namespace Raven.Documentation.Web.Helpers
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        private static MvcHtmlString GenerateNavigationFor35Or30Or40(HtmlHelper htmlHelper, Language language, string version)
        {
            ...
            builder.AppendLine(string.Format("<li>{0}</li>", htmlHelper.ActionLink("Users Issues", MVC.Docs.ActionNames.UsersIssues, MVC.Docs.Name, new { language = language, version = version }, null)));
